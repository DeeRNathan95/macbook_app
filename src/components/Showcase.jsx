                ...
                <div className="wrapper">
                    <div className = "lg:max-w-md">
                        ...
                        <div className="space-y-5 mt-7 pe-10">
                            ...
                            <p>
                                It drives Apple intelligence on IpadPro, so you can write, create, and accomplish more with ease. All in a design that's a unbelievable thin, light, and powerful.
                            </p>
                            <p>
